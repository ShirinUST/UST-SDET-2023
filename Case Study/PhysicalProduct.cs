...
namespace Case_Study
{
    ...
    {
        //public PhysicalProduct(int productId, string? name, double price, int stockQuantity,double weight,string dimension) : base(productId, name, price, stockQuantity)
        //{
        //    Weight = weight;
        //    Dimension = dimension;
        //}
